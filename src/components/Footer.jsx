...
function Foter() {
  return (
    <div className="flex justify-center items-center w-full lg:px-10 pb-10 font-normal ">
      <div className="w-full  bg-blue-100 z-100 rounded-3xl flex flex-col sm:flex-row items-start sm:items-center sm:justify-between px-4 lg:px-8 pt-5 sm:pt-9 pb-4 sm:pb-8">
